...
d2l.set_figsize()
img = d2l.Image.open(r'D:\tbw\Pytorch\Tutorial\img\cat1.jpg')   # need path
d2l.plt.imshow(img)
...
all_images = torchvision.datasets.CIFAR10(
    train=True, root=r'D:\tbw\Pytorch\Project\CIFAR10', download=True
)
...
def load_cifar10(is_train, augs, batch_size):
    dataset = torchvision.datasets.CIFAR10(root=r'D:\tbw\Pytorch\Project\CIFAR10',
...
def train_ch13(net, train_iter, test_iter, 
    ...
    animator = d2l.Animator(xlabel='epoch', xlim='[1, num_epochs]',
            y_lim=[0, 1], legend=['train loss', 'train acc', 'test acc'])
    ...
    for epoch in range(num_epochs):
        ...
        for i, (features, labels) in enumerate(train_iter):
            ...
            if (i+1) % (num_batchs//5) == 0 or i == num_batchs-1:
                animator.add(epochs+(i+1) / num_batchs, (metric[0]/metric[2], 
                metric[1]/metirc[3],None))
...
def train_with_data_aug(train_augs, test_augs, net, lr = 0.001):
    ...
    train_ch13(net, train_iter, teat_iter, loss, trainer, 10, devices)
